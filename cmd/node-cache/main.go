...
import (
	...
	// Standard CoreDNS plugins included in node-local-dns
	...
	// Redis cache plugin — shared L2 cache across node-local-dns instances
	_ "github.com/dragoangel/coredns-redis-cache-plugin"
